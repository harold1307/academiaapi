...
export type IAsignaturaModuloEnMallaRepository = {
  create(data: ICreateAsignaturaModuloEnMalla): Promise<IAsignaturaModuloEnMalla>;
	getAll(): Promise<IAsignaturaModuloEnMalla[]>;
	getById(id: string): Promise<IAsignaturaModuloEnMalla | null>;
	update(params: UpdateAsignaturaModuloEnMallaParams): Promise<IAsignaturaModuloEnMalla>;
