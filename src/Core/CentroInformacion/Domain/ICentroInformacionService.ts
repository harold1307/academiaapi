...
export type ICentroInformacionService = {
  createCentroInformacion(data: ICreateCentroInformacion): Promise<ICentroInformacion>;
	getAllCentroInformacions(): Promise<ICentroInformacion[]>;
	getCentroInformacionById(id: string): Promise<ICentroInformacion | null>;
	updateCentroInformacionById(params: UpdateCentroInformacionParams): Promise<ICentroInformacion>;
