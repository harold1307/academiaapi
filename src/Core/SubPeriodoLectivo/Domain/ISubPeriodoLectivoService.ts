...
export type ISubPeriodoLectivoService = {
  createSubPeriodoLectivo(data: ICreateSubPeriodoLectivo): Promise<ISubPeriodoLectivo>;
	getAllSubPeriodoLectivos(): Promise<ISubPeriodoLectivo[]>;
	getSubPeriodoLectivoById(id: string): Promise<ISubPeriodoLectivo | null>;
	updateSubPeriodoLectivoById(params: UpdateSubPeriodoLectivoParams): Promise<ISubPeriodoLectivo>;
