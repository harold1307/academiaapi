...
export type IAsesorEstudianteService = {
  createAsesorEstudiante(data: ICreateAsesorEstudiante): Promise<IAsesorEstudiante>;
	getAllAsesorEstudiantes(): Promise<IAsesorEstudiante[]>;
	getAsesorEstudianteById(id: string): Promise<IAsesorEstudiante | null>;
	updateAsesorEstudianteById(params: UpdateAsesorEstudianteParams): Promise<IAsesorEstudiante>;
