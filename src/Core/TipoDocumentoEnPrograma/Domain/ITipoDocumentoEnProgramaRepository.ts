...
export type ITipoDocumentoEnProgramaRepository = {
  create(data: ICreateTipoDocumentoEnPrograma): Promise<ITipoDocumentoEnPrograma>;
	getAll(): Promise<ITipoDocumentoEnPrograma[]>;
	getById(id: string): Promise<ITipoDocumentoEnPrograma | null>;
	update(params: UpdateTipoDocumentoEnProgramaParams): Promise<ITipoDocumentoEnPrograma>;
